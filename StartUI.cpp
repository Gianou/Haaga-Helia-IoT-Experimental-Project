...
void StartUI::draw(TFT_eSprite &sprite)
{
    ...
    sprite.drawString("Welcome", 36, 10);
    sprite.drawString("captain!", 36, 30);

    sprite.setTextColor(TFT_WHITE);
    sprite.setTextSize(1);
    sprite.drawString(currentCharYIndex == 0 ? "> " + stringArray[0] : stringArray[0], 35, 60);

    sprite.setTextColor(TFT_WHITE);
    sprite.setTextSize(1);
    sprite.drawString(currentCharYIndex == 1 ? "> " + stringArray[1] : stringArray[1], 35, 80);
